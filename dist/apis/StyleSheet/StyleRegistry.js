...
rnStyleNext,_ref){var _this2=this;var domClassList=_ref.classList,domStyle=_ref.style;var _domClassList$reduce=
...
var rdomStyle=Object.keys(domStyle).reduce(function(acc,styleName){
var value=domStyle[styleName];
if(value!==''){
var reactStyleName=vendorPrefixPattern.test(styleName)?
